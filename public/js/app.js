...
var addToCart = document.querySelectorAll('.add-to-cart'); // let deleteFromCart = document.querySelectorAll('.delete-from-cart');
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    ...
    updateCart(food); // console.log(food);
  });
...
updateStatus(order); // Payment section

(0,_stripe__WEBPACK_IMPORTED_MODULE_4__.initStripe)(); // Socket section
    ...
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.next = 2;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)('pk_test_51JJdXiSFC2ysPpAcbFr2KjooBXuMHHzexqTBU93DDd4xncUSMMVJzuWkr4gjtSYWulK7n2qlFZ1EH1LGbiX10kox00YIBvtTgq');
                  ...
                  return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee$(_context) {
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          e.preventDefault();
                          formData = new FormData(paymentForm); // Inbuilt class of js to fetch form details submitted
                        ...
                        case 10:
                          token = _context.sent;
                          formObject.stripeToken = token.id; // formObject.user = user;

                          (0,_apiService__WEBPACK_IMPORTED_MODULE_2__.placeOrder)(formObject); //  Pay with card
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_food_ordering"] = self["webpackChunkrealtime_food_ordering"] || [];
